...
SECRET_KEY = 'django-insecure-4xp&o*g_ik&iu_97_^w@ov67+xp^m&6m)@ig@(#rwpf1m+uyr4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'silmarmoreno.pythonanywhere.com',
    'localhost',
    '127.0.0.1'
]
...
INSTALLED_APPS = [
    ...
    'carteira',
    'financeiro',  # Adicionando o app financeiro
    'transacoes', # app para transações
